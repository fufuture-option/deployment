...
## 1、BManager.json 是整个合约交易系统合约地址入口。 管理所有的交易币对，运行时用到的 Perpetual、 OrderBook、 TradeAgent、Underlying、 PrivatePool 合约地址都是该合约获取。
## 2、LeadingContractFactory.json 是整个跟单系统地址入口。 管理所有的跟单功能，包括创建、删除具体的跟单合约。

## 合约地址：
 | 链名称       | BManager                                   | LeadingContractFactory                     | 
 |-------------|--------------------------------------------|--------------------------------------------|
 | OPBnbTest   | 0xBB7c5F93FafE4ff7CF1bd9A9C39423A2F4a44536 | 0xc0CC7f4A8E168A84A82612BF332C41e92849D826 |
